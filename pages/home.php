...
<section class="nx-section">
    <div class="container">
        ...
        <div style="max-width:700px; margin:0 auto;">
            <div class="reveal"
                style="display:flex; align-items:flex-start; gap:var(--nx-sp-6); margin-bottom:var(--nx-sp-8);">
                <div
                    style="width:48px; height:48px; background:var(--nx-blue-subtle); border-radius:var(--nx-radius-md); display:flex; align-items:center; justify-content:center; flex-shrink:0;">
                ...
                <div>
                    ...
                    <p style="margin:0; color:var(--nx-text-muted); font-size:var(--nx-fs-sm);">Linus Torvalds,
                        Helsinki'de "hobi amaçlı" bir çekirdek yazmaya başladı. GNU araçlarıyla birleşerek GNU/Linux
                        doğdu.</p>
                </div>
            </div>
            <div class="reveal"
                style="display:flex; align-items:flex-start; gap:var(--nx-sp-6); margin-bottom:var(--nx-sp-8);">
                <div
                    style="width:48px; height:48px; background:var(--nx-green-subtle); border-radius:var(--nx-radius-md); display:flex; align-items:center; justify-content:center; flex-shrink:0;">
                ...
                <div>
                    ...
                    <p style="margin:0; color:var(--nx-text-muted); font-size:var(--nx-fs-sm);">Mark Shuttleworth,
                        "herkes için Linux" vizyonuyla Ubuntu'yu çıkardı. Masaüstü Linux kullanımını patlattı.</p>
                </div>
            </div>
            <div class="reveal"
                style="display:flex; align-items:flex-start; gap:var(--nx-sp-6); margin-bottom:var(--nx-sp-8);">
                <div
                    style="width:48px; height:48px; background:var(--nx-amber-subtle); border-radius:var(--nx-radius-md); display:flex; align-items:center; justify-content:center; flex-shrink:0;">
                ...
                <div>
                    ...
                    <p style="margin:0; color:var(--nx-text-muted); font-size:var(--nx-fs-sm);">Bulut, AI, süper
                        bilgisayarlar, Steam Deck, Android — Linux artık her yerde. %100 pazar payıyla süper bilgisayar
                        tahtı.</p>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="grid grid-4 gap-6 reveal-stagger">
            <div class="nx-infographic-card reveal">
                ...
                <h4>İzin Sistemi</h4>
                <p class="text-muted" style="font-size:var(--nx-fs-sm);">Root ve kullanıcı ayrımı. Zararlı yazılım sudo
                    izni olmadan sisteme zarar veremez.</p>
            </div>
            <div class="nx-infographic-card reveal">
                ...
                <h4>Düşük Kaynak</h4>
                <p class="text-muted" style="font-size:var(--nx-fs-sm);">GUI olmadan 50MB RAM ile çalışır. Eski
                    donanımlarda bile akıcı performans.</p>
            </div>
            <div class="nx-infographic-card reveal">
                ...
                <p class="text-muted" style="font-size:var(--nx-fs-sm);">Çekirdeği yeniden derleyin, masaüstünü
                    değiştirin, her piksel sizin kontrolünüzde.</p>
            </div>
            <div class="nx-infographic-card reveal">
                ...
                <p class="text-muted" style="font-size:var(--nx-fs-sm);">APT, DNF, Pacman — güvenli depolardan tek
                    komutla yazılım kurulumu.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div style="max-width:700px; margin:0 auto;">
            ...
            <p class="text-center text-muted mt-4" style="font-size:var(--nx-fs-xs);">
                ...
                Deneyin: <code>ls</code>, <code>pwd</code>, <code>whoami</code>, <code>neofetch</code>,
                <code>help</code>
            </p>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="grid grid-3 gap-6 reveal-stagger">
            <div class="nx-feature-card reveal text-center">
                <div class="nx-icon-box nx-icon-box-blue mx-auto mb-4"
                    style="margin:0 auto var(--nx-sp-5) auto; width:64px; height:64px; font-size:1.6rem;">
                    <i class="fa-solid fa-compass"></i>
                </div>
                <h4>Dağıtım Rehberi</h4>
                <p class="text-muted" style="font-size:var(--nx-fs-sm);">Hangi dağıtım size uygun? Quiz ile en doğru
                    seçimi yapın.</p>
                <a href="index.php?page=quiz" class="btn-primary btn-sm mt-4">Teste Başla</a>
            </div>
            <div class="nx-feature-card reveal text-center">
                <div class="nx-icon-box nx-icon-box-green mx-auto mb-4"
                    style="margin:0 auto var(--nx-sp-5) auto; width:64px; height:64px; font-size:1.6rem;">
                    <i class="fa-solid fa-book-open"></i>
                </div>
                <h4>Linux Nedir?</h4>
                <p class="text-muted" style="font-size:var(--nx-fs-sm);">Çekirdek, dağıtım, açık kaynak — temel
                    kavramları öğrenin.</p>
                <a href="index.php?page=what-is-linux" class="btn-outline btn-sm mt-4">Öğrenmeye Başla</a>
            </div>
            <div class="nx-feature-card reveal text-center">
                <div class="nx-icon-box nx-icon-box-purple mx-auto mb-4"
                    style="margin:0 auto var(--nx-sp-5) auto; width:64px; height:64px; font-size:1.6rem;">
                    <i class="fa-solid fa-layer-group"></i>
                </div>
                <h4>Mimari Derinlik</h4>
                <p class="text-muted" style="font-size:var(--nx-fs-sm);">Kernel, shell, dosya sistemi — Linux nasıl
                    çalışır öğrenin.</p>
...
<section class="nx-section">
    <div class="container">
        <div class="nx-cta-banner reveal">
            ...
            <p
                style="font-size:var(--nx-fs-md); color:var(--nx-text-muted); max-width:560px; margin:0 auto var(--nx-sp-8) auto;">
                Dagitimlari kesfedin, quiz cozun, ilerlemenizi takip edin ve ozgur yazilim dunyasinin bir parcasi olun.
                INEXX INTERACTIVE tarafindan gelistirilen bir platform.
            </p>
